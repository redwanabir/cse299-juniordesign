      ...
      <nav class="navbar navbar-inverse">
        <div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand" href="sp_index.php">HomeService.com</a>
          </div>
          <ul class="nav navbar-nav">
          
            <li ><a href="index.php"> Home</a></li> ?>
			
			<li class="active"><a href=sp_profile.php?id=".$row['id']">Profile</a></li>
  ...
  <div id="main">
    ...
    <?php endif ?>
				...
				<div class="col-md-8">
                      ...
                      {  
                            $array = array();
                            $q = mysql_query("SELECT * FROM `accounts ` WHERE 'email' =".$email);
						...
						$sqlget = "SELECT * FROM accounts   WHERE email='$email'";
